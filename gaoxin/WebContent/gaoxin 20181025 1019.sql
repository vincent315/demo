...
CREATE TABLE `xiaofu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='校服';
...
INSERT INTO `xiaofu` (`id`,`sn`,`name`,`sex`,`d1`,`d2`,`d3`,`d4`,`d5`,`d6`,`d7`,`txt`,`size`) VALUES 
 ...
 (43,'0715','沈鑫阳','M',1,1,0,0,1,1,1,'','130'),
 (46,'0708','吴宇宸','M',1,1,0,0,0,0,0,'','130'),
 (47,'0704','史泰宇','M',1,1,0,0,0,0,0,'','130'),
 ...
 (66,'0755','李佳音','F',1,1,0,0,0,1,1,'','140'),
 (68,'0753','胡曦月','F',1,0,0,0,1,1,1,'','120'),
 (69,'0716','翟泓钦','M',1,1,0,0,1,1,0,'','130'),
 (70,'0742','蔡雨昕','F',1,1,0,0,0,0,1,'','120'),
 (71,'0712','干坤圻','M',1,1,0,1,1,1,0,'','120'),
 (72,'0746','范美汐','F',0,0,0,0,0,1,0,'','120'),
 (73,'0735','李书瑶','F',1,1,0,0,0,1,0,'','130'),
 (74,'0732','袁铭鹤','F',1,1,0,0,1,1,1,'','130'),
 (75,'0716','翟泓钦','M',0,1,0,0,0,0,0,'','140'),
 (76,'0736','赵嘉晨','F',1,1,0,0,1,0,0,'','130'),
 (77,'0720','刘安炆','M',1,1,0,0,0,1,0,'','130'),
 (78,'0755','李佳音','F',0,0,0,0,1,0,0,'','130');
