...
import com.hq.db.ConnectionManager;
...
public abstract class ServletBase extends HttpServlet
{
	...
	*/
	...
	/**
	 * ͨ��һ�������õ����飬name=lisi&name=wangwu&name=zs
	 * @param req
	 * @param param
	 * @return
	 */
	...
	public void getBean(ServletRequest req,Object obj)
	{
		...
		for(Field f:allf)
		{
		    ...
		    String fname=f.getName();//�õ���Ա������
		    Class ftype=f.getType();//�õ������Ա������ 
		    Object fvalue=null;
		    try {
 ...
 */
	...
	{
		ConnectionManager dm=ConnectionManager.newInstance();
